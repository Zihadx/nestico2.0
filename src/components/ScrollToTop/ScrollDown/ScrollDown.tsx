      ...
      {isVisible && (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-[999]">
          <motion.div
            ...
            className="cursor-pointer p-2 rounded-full border h-10 w-8 flex items-center justify-center shadow-xl transition-transform hover:scale-110 bg-gradient-to-r from-[#22d3ee]/70 via-[#0c3b4a]/70 to-[#104b5f]/70"
            initial={{ y: 0 }}
            animate={{ y: [0, 12, 0] }}
            transition={{
              repeat: Infinity,
